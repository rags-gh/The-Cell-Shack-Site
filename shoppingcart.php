<!-- InstanceBegin template="/Templates/cart.dwt" codeOutsideHTMLIsLocked="false" -->
      ...
      <tr>
        ...
        <table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-width: 0" bordercolor="#111111" width="100%" id="AutoNumber16">
          <tr>
            ...
            <td width="33%" style="border-style: none; border-width: medium" bgcolor="#0099FF"><!-- InstanceBeginEditable name="EditRegion1" -->Here is your shopping cart!
                <p align="right" style="margin-right: 6; margin-top: 2; margin-bottom: 2"><!-- InstanceEndEditable -->              <p align="right" style="margin-right: 6; margin-top: 2; margin-bottom: 2"></td>
          </tr>
          <tr>
            <td width="100%" colspan="3" align="center" bgcolor="#FFFFFF" style="border-style: none; border-width: medium"><!-- InstanceBeginEditable name="EditRegion5" -->
              <table width="100%" border="1">
                ...
                <tr>
                  <td align="center" valign="baseline"><form name="form1" method="post" action="orderform1.php">
...
<select name="qty1" id="qty1">
                  ...
                  <td align="center" valign="baseline"><img src="avatar122382_2.gif" width="50" height="50"></td>
                  <td valign="baseline">HTC Evo 4G</td>
                  <td valign="baseline">$199.99</td>
                </tr>
                <tr>
                  <td align="center" valign="baseline"><form name="form2" method="post" action="orderform1.php">
...
<select name="qty2" id="qty2">
                  ...
                  <td align="center" valign="baseline"><img src="2-1-Universal-Micro-USB-Mini-USB-Car-Charger-for_5076744.s.jpg" width="50" height="50"></td>
                  <td valign="baseline">MicroUSB Car Charger</td>
                  <td valign="baseline">$19.99</td>
                </tr>
                <tr>
                  <td align="center" valign="baseline"><form name="form3" method="post" action="orderform1.php">
...
<select name="qty3" id="qty3">
                  ...
                  <td align="center" valign="baseline"><img src="22690-nokia-bluetooth-headset-bh-905-1.jpg" width="50" height="50"></td>
                  <td valign="baseline">Bluetooth Headset</td>
                  <td valign="baseline">$19.99</td>
                </tr>
                <tr>
                  ...
                  <td valign="baseline"><form name="form4" method="post" action="">
                      <input type="submit" name="button" id="button" value="Submit" formaction="http://puzzle.sci.csueastbay.edu/~wj7356/thecellshack/orderform1.php" />
                  </form></td>
                </tr>
              </table>
      ...
      <tr>
        <td width="14%" style="border-style: none; border-width: medium" bgcolor="#FFFFFF" valign="top" height="1">&nbsp;</td>
        <td width="4%" style="border-style: none; border-width: medium" bgcolor="#FFFFFF" height="1">&nbsp;</td>
        <td width="46%" style="border-style: none; border-width: medium" bgcolor="#FFFFFF" valign="top" height="1">&nbsp;</td>
        <td width="3%" style="border-style: none; border-width: medium" bgcolor="#FFFFFF" height="1">&nbsp;</td>
        <td width="33%" style="border-style: none; border-width: medium" bgcolor="#FFFFFF" height="1" valign="top">&nbsp;</td>
      </tr>
      <tr bgcolor="#8D68B3">
